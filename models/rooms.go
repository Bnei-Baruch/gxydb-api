...
type roomR struct {
	DefaultGateway  *Gateway            `boil:"DefaultGateway" json:"DefaultGateway" toml:"DefaultGateway" yaml:"DefaultGateway"`
	RoomStatistic   *RoomStatistic      `boil:"RoomStatistic" json:"RoomStatistic" toml:"RoomStatistic" yaml:"RoomStatistic"`
	CompositesRooms CompositesRoomSlice `boil:"CompositesRooms" json:"CompositesRooms" toml:"CompositesRooms" yaml:"CompositesRooms"`
...
func (r *roomR) GetDefaultGateway() *Gateway {
	if r == nil {
		return nil
	}
...
func (r *roomR) GetRoomStatistic() *RoomStatistic {
	if r == nil {
		return nil
	}
	return r.RoomStatistic
}

func (r *roomR) GetCompositesRooms() CompositesRoomSlice {
	if r == nil {
		return nil
	}
	return r.CompositesRooms
}

func (r *roomR) GetSessions() SessionSlice {
	if r == nil {
		return nil
	}
	return r.Sessions
...
var (
	...
	roomColumnsWithoutDefault = []string{"name", "default_gateway_id", "gateway_uid"}
	roomColumnsWithDefault    = []string{"id", "disabled", "properties", "created_at", "updated_at", "removed_at", "extra", "region"}
...
func (o *Room) RoomStatistic(mods ...qm.QueryMod) roomStatisticQuery {
	...
	return RoomStatistics(queryMods...)
}
...
func (o *Room) CompositesRooms(mods ...qm.QueryMod) compositesRoomQuery {
	...
	return CompositesRooms(queryMods...)
}
...
func (roomL) LoadDefaultGateway(e boil.Executor, singular bool, maybeRoom interface{}, mods queries.Applicator) error {
	...
	if singular {
		...
		args[object.DefaultGatewayID] = struct{}{}
		...
		for _, obj := range slice {
			...
			args[obj.DefaultGatewayID] = struct{}{}
...
func (roomL) LoadRoomStatistic(e boil.Executor, singular bool, maybeRoom interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`room_statistics`),
		qm.WhereIn(`room_statistics.room_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (roomL) LoadCompositesRooms(e boil.Executor, singular bool, maybeRoom interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`composites_rooms`),
		qm.WhereIn(`composites_rooms.room_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (roomL) LoadSessions(e boil.Executor, singular bool, maybeRoom interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`sessions`),
		qm.WhereIn(`sessions.room_id in ?`, argsSlice...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Room) Upsert(exec boil.Executor, updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns, opts ...UpsertOptionFunc) error {
	if o == nil {
...
func (o *Room) Exists(exec boil.Executor) (bool, error) {
	return RoomExists(exec, o.ID)
}
