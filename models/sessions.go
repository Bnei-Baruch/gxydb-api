...
var SessionTableColumns = struct {
	...
	GatewayID:             "sessions.gateway_id",
	GatewaySession:        "sessions.gateway_session",
	GatewayHandle:         "sessions.gateway_handle",
	GatewayFeed:           "sessions.gateway_feed",
	Display:               "sessions.display",
	Camera:                "sessions.camera",
	Question:              "sessions.question",
	SelfTest:              "sessions.self_test",
	SoundTest:             "sessions.sound_test",
	UserAgent:             "sessions.user_agent",
	IPAddress:             "sessions.ip_address",
	Properties:            "sessions.properties",
	CreatedAt:             "sessions.created_at",
	UpdatedAt:             "sessions.updated_at",
	RemovedAt:             "sessions.removed_at",
	Extra:                 "sessions.extra",
	GatewayHandleTextroom: "sessions.gateway_handle_textroom",
}
...
func (r *sessionR) GetGateway() *Gateway {
	if r == nil {
		return nil
	}
	return r.Gateway
...
var (
	...
	sessionColumnsWithDefault    = []string{"id", "room_id", "gateway_id", "gateway_session", "gateway_handle", "gateway_feed", "display", "camera", "question", "self_test", "sound_test", "user_agent", "ip_address", "properties", "created_at", "updated_at", "removed_at", "extra", "gateway_handle_textroom"}
