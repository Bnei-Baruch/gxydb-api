...
// DateTime is a Janus-specific date time format

type DateTime struct {
	time.Time
}

const dtFormat = "2006-01-02T15:04:05Z0700"
...
// ParseMessage parses a raw Janus message.
...
// ParseEvent parses a Janus event.
...
// ParseTextroomMessage parses a textroom post message.
